    ...
    .catch((err) => {
      ...
      dispatch({
        ...
        payload: {
          alert_level: "danger",
          alert_message:
            "Incorrect credentials please try again, with the correct credentials",
        },
      });
    });
};
  ...
  axios({
    ...
    .then((response) => {
      ...
      dispatch({
        ...
        payload: {
          alert_level: "success",
          alert_message: "your signup was succesful",
        },
      });
    ...
    .catch((err) => {
      ...
      dispatch({
        ...
        payload: {
          alert_level: "danger",
          alert_message:
            "A user with thesame username already exists, please choose another username.",
        },
      });
    });
};
